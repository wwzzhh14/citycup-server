...
<div id="kline" style="width: 800px;height:600px;"></div>
</body>
...
//        var  data0 = 0;
//        jQuery.getJSON("http://stock2.finance.sina.com.cn/futures/api/json.php/InnerFuturesService.getInnerFuturesDailyKLine?symbol=AU1612&jsoncallback=?",
//                function  (data) {
//
//                    console.log('qqqq');
//                    data0 = data;
...
//        console.log(data0);
        	    ...
        	    $.ajax({
                    type : "get", //jquey是不支持post方式跨域的
                        async:false,
                	        url : "http://stock2.finance.sina.com.cn/futures/api/json.php/InnerFuturesService.getInnerFuturesDailyKLine?symbol=AU1612", //跨域请求的URL
                	        dataType : "jsonp",
...
//    var url = "http://stock2.finance.sina.com.cn/futures/api/json.php/InnerFuturesService.getInnerFuturesDailyKLine?symbol=AU1612&callback=?";
//    $.getJSON(url, function(data){
//        alert(data);
////    });
//    function dataC(datas){
//        alert(1);
//    }
//
//
...
//        $.ajax({
//            type:'GET',
//            url:'http://stock2.finance.sina.com.cn/futures/api/json.php/InnerFuturesService.getInnerFuturesDailyKLine?symbol=AU1612',
...
//            jsonpCallback:"dataC",//自定义的jsonp回调函数名称，默认为jQuery自动生成的随机函数名，也可以写"?"，jQuery会自动为你处理数据
//            success: function(data){
//                alert('3');
//            },
//            error: function(){
